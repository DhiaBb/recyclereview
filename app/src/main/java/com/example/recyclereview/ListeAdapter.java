...
public class ListeAdapter extends RecyclerView.Adapter<ListeAdapter.MVH> {
    Context c;
    String[] titre,stitre;
    Integer[] image;

    public ListeAdapter(Context c, String[] titre, String[] stitre, Integer[] image) {
        this.c = c;
        this.titre = titre;
        this.stitre = stitre;
        this.image = image;
    ...
    public MVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        ListeAdapter.MVH mvh=new ListeAdapter.MVH(v);
        return mvh;
    }
